...
function FilmCutDetailDeleteAlert({ target, isOpen, onClose }: FilmCutReviewDeleteAlert): React.ReactElement {
    ...
    <AlertDialog isOpen={isOpen} leastDestructiveRef={cancelRef} onClose={onClose}>
      <AlertDialogOverlay>
        <AlertDialogContent>
          ...
          <AlertDialogBody>감상을 삭제하시겠습니까? 되돌릴 수 없습니다.</AlertDialogBody>
